...
class _MockExecutableElement2 implements ExecutableElement2 {
  ...
  _MockExecutableElement2(this._name, this._enclosingElement, this._firstFragment);
...
ExecutableElement2 createMockExecutableElement2({
  ...
  final mockEnclosingElement = enclosingElementName != null 
      ? _MockElement2(enclosingElementName) 
      : null;
